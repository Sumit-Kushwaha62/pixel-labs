        ...
        <div className="container">
          ...
          <div className="portfolio-grid">
            {filtered.map(p => (
              ...
              >
                <div className="port-card__mockup" style={{ background: `${p.color}15` }}>
                  <span className="port-card__emoji">{p.emoji}</span>
                  <div className="port-card__glow" style={{ background: p.color }} />
      ...
      {selected && opened && (
        <div className="port-modal" onClick={() => setSelected(null)}>
          <div className="port-modal__box" onClick={e => e.stopPropagation()}>
            ...
            <div className="port-modal__top" style={{ background: `${opened.color}15` }}>
              <span style={{ fontSize: 64 }}>{opened.emoji}</span>
            </div>
      ...
      <section className="section" style={{ background: 'var(--bg-card)' }}>
        <div className="container">
          <div className="home-cta__inner">
            ...
            <p className="home-cta__sub">Free consultation · Quick turnaround · Quality guaranteed</p>
